...
public class IndividualEagleExample {
    ...
    public static void createAndAddIndividualPattern(final List<MagmaCoreService> mcDatasets) {
        ...
        // Find supertypes
        List<List<Thing>> supertypes = FindSupertypes.findSuperTypes(List.of("functional_object", "state_of_functional_object", "kind_of_functional_object", "class_of_state_of_functional_object"));
        ...
        lunarLanderKindObject.addStringValue(PatternsUtils.COMMENT, "Kind_of_functional_object_that_is_Lunar_Lander");
        ...
        lunarLanderClassOfStateObject.addStringValue(PatternsUtils.COMMENT, "Class_of_state_of_functional_object_that_is_temporal_part_of_Lunar_Lander");
        ...
        try {
            ...
            final PrintStream stmt_stream_out = new PrintStream("example-files/individualEaglePattern.stmt");

            individualService.exportTtl(ttl_stream_out);
            ttl_stream_out.close();
            System.out.println("\tData being generated as TTL in example-files/individualEaglePattern.ttl.");

            individualService.exportStatements(stmt_stream_out);
            stmt_stream_out.close();
            System.out.println("\tData generated as statements in example-files/individualEaglePattern.stmt.");
